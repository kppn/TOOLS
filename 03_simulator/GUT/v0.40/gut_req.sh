...
GW    => '172.30.33.47',		# IP of ESPGW FS.
...
OWN => {
IP      => '172.30.32.162',	# command ip   of gut_req.sh. 
PORT    => 50000,		# command port of gut_req.sh. select one of some.
},

DST => {
IP      => '172.30.32.162',	# command ip   of GUT. see gut.conf
...
'mopera.ne.jp' => {
   route4 => '192.171.61.0/25',
   route6 => '2001:1::/64',
},

'mopero.ne.jp' => {
   route4 => '192.171.61.128/25',
   route6 => '2001:1::1/128',
},
